/*
 *   libMatematicas.h
 *   Funcoes que dao suporte aos programas cientificos
 */
...
/*
 * Mostra Vetores e Matrizes
 */


void mostraMatriz1dim(double matriz[], long int tamanho) {
   long int i;
...
void tempoFinal(const char *medida, char *nomeArquivo, char *msglog) {
   ...
   long int micro = (((t2.tv_sec*1000000)+t2.tv_usec) - ((t1.tv_sec*1000000)+t1.tv_usec));
    ...
    if (strcmp(medida,"micro segundos")==0)
       sprintf(tempo,"Tempo total=%d us", micro);
